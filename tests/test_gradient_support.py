...
from src.ir.gradient import IrColorFill, IrColorStop, IrLinearGradient, IrRadialGradient
...
class TestGradientCodeGeneration:
  ...
  def test_linear_gradient_code_generation(self):
    ...
    gradient = IrLinearGradient(
      ...
      end_x=100.0,
      end_y=0.0,
      color_stops=[IrColorStop(offset=0.0, color=red), IrColorStop(offset=1.0, color=blue)],
    )
  ...
  def test_radial_gradient_code_generation(self):
    ...
    gradient = IrRadialGradient(
      ...
      center_y=50.0,
      radius=40.0,
      color_stops=[IrColorStop(offset=0.0, color=white), IrColorStop(offset=1.0, color=black)],
    )
