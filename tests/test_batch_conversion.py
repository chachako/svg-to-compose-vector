...
<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  def test_batch_dry_run(self, runner, sample_svgs):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      result = runner.invoke(cli, ["batch", str(input_dir), "--dry-run"])
  ...
  def test_batch_basic_conversion(self, runner, sample_svgs):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      result = runner.invoke(cli, ["batch", str(input_dir), "-o", str(output_dir)])
  ...
  def test_batch_without_namespace_dirs(self, runner, sample_svgs):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      result = runner.invoke(
        cli, ["batch", str(input_dir), "-o", str(output_dir), "--no-namespace-dirs"]
      )
  ...
  def test_batch_with_composable_template(self, runner, sample_svgs):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      result = runner.invoke(
        cli, ["batch", str(input_dir), "-o", str(output_dir), "-t", "composable_function"]
      )
  ...
  def test_batch_overwrite_handling(self, runner, sample_svgs):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      result = runner.invoke(
        cli, ["batch", str(input_dir), "-o", str(output_dir)], input="n\n"
      )  # Say no to overwrite
      ...
      result = runner.invoke(cli, ["batch", str(input_dir), "-o", str(output_dir), "--overwrite"])
...
object {{ icon }}Icon {
  val vector: ImageVector by lazy {
    {{ build_code | indent(4, first=False) }}
      ...
      result = runner.invoke(
        cli, ["batch", str(input_dir), "-o", str(output_dir), "-t", str(template_path)]
      )
  ...
  def test_batch_with_config_file(self, runner, sample_svgs):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      result = runner.invoke(
        cli, ["batch", str(input_dir), "-o", str(output_dir), "-c", str(config_path)]
      )
...
<svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  ...
  def test_batch_mixed_naming_patterns(self, runner):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      result = runner.invoke(cli, ["batch", str(input_dir), "-o", str(output_dir), "--dry-run"])
