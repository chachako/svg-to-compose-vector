...
class IrArcTo(IrPathNode):
  ...
  def to_compose_dsl(self) -> str:
    return (f"arcTo({self.horizontal_ellipse_radius}f, {self.vertical_ellipse_radius}f, "
...
class IrRelativeCurveTo(IrPathNode):
  ...
  def to_compose_dsl(self) -> str:
    return (f"curveToRelative({self.dx1}f, {self.dy1}f, {self.dx2}f, {self.dy2}f, "
...
class IrRelativeArcTo(IrPathNode):
  ...
  def to_compose_dsl(self) -> str:
    return (f"arcToRelative({self.horizontal_ellipse_radius}f, {self.vertical_ellipse_radius}f, "
            f"{self.theta}f, {str(self.is_more_than_half).lower()}, "
